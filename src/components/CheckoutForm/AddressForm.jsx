...
import { InputLabel, Select, MenuItem, Grid, Button, Typography, Menu } from '@material-ui/core';
...
const AddressForm = ({ checkoutToken, next }) => {
    ...
    const fetchSubdivisions = async (countryCode) => {
        const { subdivisions } = await commerce.services.localeListShippingSubdivisions(checkoutToken, countryCode);
